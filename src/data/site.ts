...
export const copy: Record<Locale, Copy> = {
  de: {
    ...
    legal: { privacyTitle: 'Datenschutzerklärung', imprintTitle: 'Impressum', updated: 'Letzte Aktualisierung: 3. September 2026', privacy: ['NextGen Capture speichert Screenshots, Bildschirmaufnahmen, Bearbeitungsstände, Seitentitel, Domains und Einstellungen lokal im Browser. Inhalte verlassen die Erweiterung erst nach einer von dir ausgelösten Export- oder Slack-Freigabe.', 'Wenn du Slack ausdrücklich verbindest und im Editor auf „In Slack senden“ klickst, überträgt die Erweiterung nur das ausgewählte Bild, einen optionalen Begleittext und das gewählte Slack-Ziel direkt an Slack. Ohne diese Aktion gehen keine Bilder oder Texte an Slack. Slack-Zugangsdaten und zuletzt verwendete Ziele bleiben lokal im Browser; NextGen Capture betreibt keinen Server für diese Freigabe.', 'Die Erweiterung überträgt keine Telemetrie, Fehlerberichte oder Aufnahmeinhalte an einen Telemetrie-Dienst. Diese Website verwendet keine Analyse- oder Marketing-Tracker und setzt keine Cookies.', 'Für Support und Fehlerberichte entscheidest du selbst, ob du ein öffentliches GitHub-Issue erstellst. Veröffentliche dort keine personenbezogenen Daten, Zugangsdaten oder vertraulichen Aufnahmen.', 'Fragen zum Datenschutz kannst du an contact@nextgencapture.app richten.'], imprint: [{ heading: 'Angaben gemäß § 5 DDG', lines: ['Christian Hofmann', 'Schönerbergweg 9', '86929 Penzing', 'Deutschland'] }, { heading: 'Kontakt', lines: ['Telefon: +49 173 7597034', 'E-Mail: contact@nextgencapture.app', 'Website: nextgencapture.app'] }, { heading: 'Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV', lines: ['Christian Hofmann', 'Schönerbergweg 9', '86929 Penzing'] }], back: 'Zur Website' },
  ...
  en: {
    ...
    legal: { privacyTitle: 'Privacy policy', imprintTitle: 'Legal notice', updated: 'Last updated: September 3, 2026', privacy: ['NextGen Capture stores screenshots, screen recordings, editing states, page titles, domains, and settings locally in the browser. Content leaves the extension only after an export or Slack-sharing action you initiate.', 'When you explicitly connect Slack and click “Send to Slack” in the editor, the extension sends only the selected image, an optional message, and the selected Slack destination directly to Slack. No images or text are sent to Slack without that action. Slack credentials and recently used destinations remain local in the browser; NextGen Capture does not operate a server for this sharing flow.', 'The extension does not transmit telemetry, error reports, or capture contents to a telemetry service. This website uses no analytics or marketing trackers and sets no cookies.', 'For support and bug reports, you decide whether to create a public GitHub issue. Do not publish personal data, credentials, or confidential captures there.', 'For privacy questions, contact contact@nextgencapture.app.'], imprint: [{ heading: 'Information pursuant to Section 5 DDG', lines: ['Christian Hofmann', 'Schönerbergweg 9', '86929 Penzing', 'Germany'] }, { heading: 'Contact', lines: ['Phone: +49 173 7597034', 'Email: contact@nextgencapture.app', 'Website: nextgencapture.app'] }, { heading: 'Responsible for content pursuant to Section 18 (2) MStV', lines: ['Christian Hofmann', 'Schönerbergweg 9', '86929 Penzing'] }], back: 'Back to website' },
